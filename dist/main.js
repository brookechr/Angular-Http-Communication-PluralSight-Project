...
var AddBookComponent = /** @class */ (function () {
    ...
    AddBookComponent.prototype.saveBook = function (formValues) {
        ...
        newBook.bookID = 0; //server gives it a real id
        console.log(newBook);
...
var AddHeaderInterceptor = /** @class */ (function () {
    ...
    AddHeaderInterceptor.prototype.intercept = function (req, next) {
        console.log("AddHeaderInteceptor - " + req.url);
...
/* harmony import */ var app_services_http_cache_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/services/http-cache.service */ "./src/app/services/http-cache.service.ts");
...
var CacheInterceptor = /** @class */ (function () {
    ...
    CacheInterceptor.prototype.intercept = function (req, next) {
        ...
        if (cachedResponse) {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(cachedResponse); //no need to do next.handle b/c doesn't need to be passed on any further
        }
    ...
    CacheInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [app_services_http_cache_service__WEBPACK_IMPORTED_MODULE_2__["HttpCacheService"]])
    ], CacheInterceptor);
    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                //order of interceptors in this array determines the order in which they are used
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _add_header_interceptor__WEBPACK_IMPORTED_MODULE_7__["AddHeaderInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _log_response_interceptor__WEBPACK_IMPORTED_MODULE_8__["LogResponseInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _cache_interceptor__WEBPACK_IMPORTED_MODULE_9__["CacheInterceptor"], multi: true }
            ]
        }),
...
var LogResponseInterceptor = /** @class */ (function () {
    ...
    LogResponseInterceptor.prototype.intercept = function (req, next) {
        console.log("LogResponseInteceptor - " + req.url);
        return next.handle(req)
...
/* harmony import */ var app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/models/bookTrackerError */ "./src/app/models/bookTrackerError.ts");
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        //calls service instead of taking hardcoded data
        var resolvedData = this.route.snapshot.data['resolvedBooks'];
        if (resolvedData instanceof app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_3__["BookTrackerError"]) {
            console.log("Dashboard component error: " + resolvedData.friendlyMessage);
        }
        else {
            this.allBooks = resolvedData;
        }
        this.dataService.getAllReaders().subscribe(function (data) { return _this.allReaders = data; }, function (err) { return console.log(err); });
...
module.exports = __webpack_require__(/*! C:\Users\bchristiansen\Downloads\booktracker\src\main.ts */"./src/main.ts");
